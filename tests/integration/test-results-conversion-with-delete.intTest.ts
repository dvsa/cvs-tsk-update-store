...
export const testResultsConversionWithDelete = () =>
  describe("convertTestResults() integration tests with delete", async () => {
    ...
    testResultsJsonWithTestTypes.testResultId.S =
      testResultsJsonWithTestTypes.testResultId.S + "-D";
    testResultsJsonWithTestTypes.systemNumber.S =
      testResultsJsonWithTestTypes.systemNumber.S + "-D";
    testResultsJsonWithNoSystemNumber.testResultId.S =
      testResultsJsonWithNoSystemNumber.testResultId.S + "-D";
    testResultsJsonWithoutTestTypes.testResultId.S =
      testResultsJsonWithoutTestTypes.testResultId.S + "-D";
    testResultsJsonWithoutTestTypes.systemNumber.S =
      testResultsJsonWithoutTestTypes.systemNumber.S + "-D";
