...
export const testResultsConversionWithUpsert = () => describe("convertTestResults() integration tests with upsert", () => {
    ...
    it("should correctly convert a DynamoDB event into Aurora rows", async () => {
        ...
        expect(vehicleResultSet.rows[0].system_number).toEqual("SYSTEM-NUMBER-5-U");
    ...
    it("A new Test Result with two TestTypes is inserted correctly", async () => {
        ...
        expect(vehicleResultSet.rows.length).toEqual(1);
        expect(vehicleResultSet.rows[0].system_number).toEqual("SYSTEM-NUMBER-3-U");
    ...
    it("A new Test Result with no TestTypes is inserted correctly", async () => {
        ...
        expect(vehicleResultSet.rows.length).toEqual(1);
        expect(vehicleResultSet.rows[0].system_number).toEqual("SYSTEM-NUMBER-4-U");
