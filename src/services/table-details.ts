...
export const VEHICLE_TABLE: TableDetails = {
  tableName: "vehicle",
  columnNames: ["system_number", "vin", "vrm_trm", "trailer_id", "createdAt"],
};
...
export const VEHICLE_SUBCLASS_TABLE: TableDetails = {
  ...
  columnNames: ["vehicle_class_id", "subclass"],
};

export const IDENTITY_TABLE: TableDetails = {
  tableName: "identity",
  columnNames: ["identityId", "name"],
};
...
export const AXLE_SPACING_TABLE: TableDetails = {
  ...
  columnNames: ["technical_record_id", "axles", "value"],
};
...
export const TEST_STATION_TABLE: TableDetails = {
  ...
  columnNames: ["pNumber", "name", "type"],
};

export const TESTER_TABLE: TableDetails = {
  tableName: "tester",
  columnNames: ["staffId", "name", "email_address"],
};

export const FUEL_EMISSION_TABLE: TableDetails = {
  tableName: "fuel_emission",
  columnNames: ["modTypeCode", "description", "emissionStandard", "fuelType"],
};

export const TEST_TYPE_TABLE: TableDetails = {
  tableName: "test_type",
  columnNames: ["testTypeClassification", "testTypeName"],
};

export const PREPARER_TABLE: TableDetails = {
  tableName: "preparer",
  columnNames: ["preparerId", "name"],
};
