...
import {
  ...
  parseApplicantDetailsProperties,
} from './applicant-details-properties';
import { parsePurchaserDetails, PurchaserDetails } from './purchaser-details';
import {
  ManufacturerDetails,
  parseManufacturerDetails,
} from './manufacturer-details';
...
const parseTechRecord = (image: DynamoDbImage): TechRecord => ({
  ...
  fuelPropulsionSystem: image.getString(
    'fuelPropulsionSystem',
  ) as FuelPropulsionSystem,
  ...
  applicantDetails: parseApplicantDetailsProperties(
    image.getMap('applicantDetails'),
  ),
  purchaserDetails: parsePurchaserDetails(image.getMap('purchaserDetails')),
  manufacturerDetails: parseManufacturerDetails(
    image.getMap('manufacturerDetails'),
  ),
  ...
  frontVehicleTo5thWheelCouplingMin: image.getNumber(
    'frontVehicleTo5thWheelCouplingMin',
  ),
  frontVehicleTo5thWheelCouplingMax: image.getNumber(
  ...
  centreOfRearmostAxleToRearOfTrl: image.getNumber(
  ...
  seatbeltInstallationApprovalDate: image.getString(
