...
export const parseTestResult = (image: DynamoDbImage): TestResult => {
    return {
        ...
        createdAt: image.getDateTime("createdAt"),
        createdByName: image.getString("createdByName"),
        createdById: image.getString("createdById"),
        lastUpdatedAt: image.getDateTime("lastUpdatedAt"),
        ...
        testStartTimestamp: image.getDateTime("testStartTimestamp"),
        testEndTimestamp: image.getDateTime("testEndTimestamp"),
